...
FIRST VIEWPORT: Slim brand masthead; large single-line illuminated title over the left two-thirds with a compact refresh action;
subscriptions above a horizontal control deck; watch-state navigation and real poster shelves visible
at desktop height. Mobile stacks the deck into two-column controls without truncating labels.
SIGNATURE: The title powers on once with a short shadow transition; poster sleeves lift on hover.
Reduced motion shows the settled design immediately.
...
The storefront on the right is a generated decorative plate. Real catalog posters and metadata replace
...
IMPLEMENTED ADAPTATION: Shell max-width 1515px with 42px desktop gutters; four, three, and two
